...
import cn.edu.gdut.douyintoutiao.adapter.FollowTagsListAdapter;
...
public class FollowTagsListFragment extends Fragment {
    ...
    //自定义recyclerveiw的适配器
    private FollowTagsListAdapter mCollectRecyclerAdapter;
    ...
    private void initRecyclerView() {
        ...
        //创建adapter
        mCollectRecyclerAdapter = new FollowTagsListAdapter(tagsList);
